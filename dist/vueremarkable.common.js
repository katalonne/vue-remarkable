...
for (var index_browser_i = 0; index_browser_i < 256; index_browser_i++) { ESCAPED.push(0); }
...
// CONCATENATED MODULE: ./src/remarkable.js
/* eslint-disable prettier/prettier */

/* harmony default export */ var remarkable = ({
  name: 'vue-remarkable',
  props: {
    options: {
      type: Object,
  ...
  methods: {
    content: function content() {
      ...
      if (this.source) {
        return h("span", {
          "domProps": {
            "innerHTML": this.renderMarkdown(this.source.trim())
          }
        });
      } else {
        if (this.$slots.default) {
          var textChildren = this.$slots.default.filter(function (s) {
            return s.tag == undefined;
          });
          var markdownSlotText = textChildren.reduce(function (acc, current) {
          ...
          return h("span", {
            "domProps": {
              "innerHTML": this.renderMarkdown(markdownSlotText)
            }
          });
        }
      }
...
/* harmony default export */ var entry_lib = __webpack_exports__["default"] = (remarkable);
...
/******/ })["default"];
//# sourceMappingURL=vueremarkable.common.js.map